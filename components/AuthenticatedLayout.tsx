  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden" style={{ position: 'relative' }}>
      ...
      <header style={{
        ...
        <div className="flex justify-between items-center" style={{ gap: '8px', paddingLeft: '4px', paddingRight: '4px', paddingTop: 'calc(12px + env(safe-area-inset-top))', paddingBottom: '8px' }}>

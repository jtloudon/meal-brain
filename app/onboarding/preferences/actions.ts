...
8. Serve curry over rice`,
      ...
      ingredients: [
        { ingredient_name: 'chicken breast', quantity_min: 1.5, quantity_max: null, unit: 'lb', display_name: 'chicken breast' },
        { ingredient_name: 'rice', quantity_min: 2, quantity_max: null, unit: 'cup', display_name: 'rice' },
        { ingredient_name: 'coconut milk', quantity_min: 1, quantity_max: null, unit: 'can', display_name: 'coconut milk' },
        { ingredient_name: 'curry powder', quantity_min: 2, quantity_max: null, unit: 'tbsp', display_name: 'curry powder' },
        { ingredient_name: 'onion', quantity_min: 1, quantity_max: null, unit: 'whole', display_name: 'onion' },
        { ingredient_name: 'garlic', quantity_min: 3, quantity_max: null, unit: 'clove', display_name: 'garlic' },
      ],
    },
    {
...
6. Assemble: shells, beef, lettuce, tomato, cheese`,
      ...
      ingredients: [
        { ingredient_name: 'ground beef', quantity_min: 1, quantity_max: null, unit: 'lb', display_name: 'ground beef' },
        { ingredient_name: 'taco shells', quantity_min: 12, quantity_max: null, unit: 'whole', display_name: 'taco shells' },
        { ingredient_name: 'lettuce', quantity_min: 1, quantity_max: null, unit: 'cup', display_name: 'lettuce, shredded' },
        { ingredient_name: 'tomato', quantity_min: 2, quantity_max: null, unit: 'whole', display_name: 'tomatoes, diced' },
        { ingredient_name: 'cheddar cheese', quantity_min: 1, quantity_max: null, unit: 'cup', display_name: 'cheddar cheese, shredded' },
      ],
    },
    {
...
8. Top with salsa or hot sauce if desired`,
      ...
      ingredients: [
        { ingredient_name: 'black beans', quantity_min: 2, quantity_max: null, unit: 'can', display_name: 'black beans, drained' },
        { ingredient_name: 'onion', quantity_min: 1, quantity_max: null, unit: 'whole', display_name: 'onion, diced' },
        { ingredient_name: 'bell pepper', quantity_min: 1, quantity_max: null, unit: 'whole', display_name: 'bell pepper, sliced' },
        { ingredient_name: 'taco shells', quantity_min: 12, quantity_max: null, unit: 'whole', display_name: 'taco shells' },
        { ingredient_name: 'lettuce', quantity_min: 1, quantity_max: null, unit: 'cup', display_name: 'lettuce, shredded' },
        { ingredient_name: 'olive oil', quantity_min: 1, quantity_max: null, unit: 'tbsp', display_name: 'olive oil' },
      ],
    },
  ];
